...
then
	...
	v4l2-ctl --set-fmt-video=width=864,height=480,pixelformat=1
	v4l2-ctl --set-parm=15
	sudo ./mjpg_streamer -i "./input_uvc.so -fps 15 -r 864x480 -d /dev/video0 -n" -o "./output_http.so -w ./www -p 8090"
